...
$(function() {
	...
	CKEDITOR.config.allowedContent = true;	// html 태그가 사라지는 걸 방지
	
	var formBtn = $("#formBtn");
	formBtn.on("click", function() {
		var title = $('#boTitle').val();		// 제목 데이터 얻어오기 
//		var content = $('#boContent').val();	// 내용 데이터 얻어오기
		...
		// 등록일때와 수정 일 때를 구분해서 방향만 살짝 틀어주면 등록이되고 수정이된다.
		if($(this).val() == "수정"){
			$('#boardForm').attr('action', '/board/update.do');	// 수정을 하러 가기 위해 url 경로를 틀어준다.
		}
