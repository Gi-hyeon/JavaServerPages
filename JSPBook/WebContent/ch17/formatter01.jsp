                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                %>
	                                ...
	                                <c:set var="num1" value="<%=num1 %>"></c:set>
	                                <c:set var="num2" value="<%=num2 %>"></c:set>
	                                <c:set var="num3" value="<%=num3 %>"></c:set>
	                                <c:set var="num4" value="<%=num4 %>"></c:set>
                                	
                                	<!-- 
                                		formatNumber 태그
                                		- type : type 속성이 "currency"일 경우 인식할 화폐 단위
                                			ㄴ> 해당 화폐 단위는 브라우저에서 설덩되어 있는 통화 기호를 기준으로 설정
