                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                	<!-- get은 action에 url?a=1 데이터를 넘기고
                                		submit을 누르면 url 뒤에 값들이 null로 들어감  -->
                                	<form action="form04_process.jsp" name="member" method="post">
                                		...
                                		취미 : <input type="checkbox" name="hobby1" checked="checked">독서
                                		...
                                		<!-- 
                                		 ...
                                		 -->
                                		자기소개 : <textarea rows="3" cols="30" name="comment" wrap="soft" placeholder="가입인사를 알려주세요."></textarea><br>
                                		<input type="submit" value="가입하기">
                                		<input type="submit" value="다시쓰기"><br>
                                	</form>
                                </div>
                            </div>
                        </div>
