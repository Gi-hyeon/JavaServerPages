...
public class BookDAO {
	 ...
	 * 그리고, useGeneratedKey와 keyProperty의 설정으로 book테이블의 pk인 book_id 항목을 생성할 수 있다.(mapper xml 참고)
	 */
	...
	public int updateBook(Map<String, Object> map) {
		/*
		 * sqlSessionTemplate객체의 updateBook 메소드는 insert 메소드와 사용법이 동일하다.
		 * 첫 번째 파라미터는 쿼리 ID, 두 번째 파라미터는 쿼리 파라미터이고 반환값은 영향받은 행 수이다.
		 */
	...
	public int removeBook(Map<String, Object> map) {
		/*
		 * sqlSessionTemplate객체의 removeBook 메소드는 update 메소드와 사용법이 동일하다.
		 * 첫 번째 파라미터는 쿼리 ID, 두 번째 파라미터는 쿼리 파라미터이고 반환값은 영향받은 행 수이다.
		 */
	...
	public List<Map<String, Object>> selectBookList(Map<String, Object> map) {
		 ...
		 * 첫 번째 파라미터는 쿼리 ID, 두 번째 파라미터는 쿼리파라미터이다.
